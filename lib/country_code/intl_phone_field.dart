                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (ctx, index) => Column(
                      children: <Widget>[
                        ListTile(
                          leading: Image.asset(
                            'assets/images/${filteredCountries[index]['code'].toLowerCase()}.png',
        ...
        Expanded(
          child: TextFormField(
            ...
            onSaved: (value) async {
              ...
              sharedPreferences.setString(SP_COUNTRY_CODE, _selectedCountry['dial_code']);
            },
            onChanged: (value) {
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Image.asset(
                "assets/images/${_selectedCountry['code'].toLowerCase()}.png",
                /*package: 'intl_phone_field',*/
                width: 22,
              ),
              SizedBox(width: 6),
