...
import 'package:chores_app/ui/dialog/mult_select_dialog.dart';
import 'package:chores_app/utils/chores_constant.dart';
import 'package:chores_app/utils/multi_select_item.dart';
import 'package:chores_app/utils/multi_select_list_type.dart';
    ...
    await showDialog(
      ...
      builder: (ctx) {
        return MultiSelectDialog<V>(
          ...
          items: widget.items,
          title: widget.title != null ? widget.title : Text(SELECT_MEMBER),
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: <Widget>[
                widget.buttonText ?? Text(SELECT_MEMBER,style: TextStyle(fontWeight: FontWeight.bold),),
