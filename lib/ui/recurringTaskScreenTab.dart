...
class RecurringTaskScreenTab extends StatefulWidget {
  @override
  _RecurringTaskScreenTabState createState() => _RecurringTaskScreenTabState();
}

class _RecurringTaskScreenTabState extends State<RecurringTaskScreenTab> {
  bool flag = false;
  ...
  Widget _buildItem(BuildContext context, TaskMember values,
    ...
    return SizeTransition(
      ...
      child: Card(
        ...
        child: ListTile(
          onTap: () => {
            // now recurring task not need to mark as complete
           /* Navigator.push(
                context,
                MaterialPageRoute(
